							...
							<div class="card prod-p-card card-red">
								<div class="card-body">
									<div class="row align-items-center m-b-30">
										<div class="col">
											<h6 class="m-b-5 text-white">Total Nilai Rata-Rata Seluruh Mata Pelajaran : </h6>
											<h1 class="m-b-0 f-w-700 text-white">
												<span style="font-size: 0.7em">Nilai :</span>
												<?php $rt = $mapel;
															$jmrata = $nilai->jrata;
															echo number_format($ratarata = $jmrata/$rt, 2); ?>
											 </h1>
										</div>
										<div class="col-auto">
											<i class="fas fa-edit text-c-red f-18"></i>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-12">
							<div class="card product-progress-card">
								<div class="card-header">
									<h5>Rata-rata nilai siswa seluruh mata pelajaran :</h5>
