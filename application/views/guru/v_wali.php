		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Wali Kelas</h5>
						<span>Berikut data para wali kelas.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						<li class="breadcrumb-item">
							<a href="<?= site_url('wali/home') ?>"><i class="feather icon-home"></i></a>
						</li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('wali/wali') ?>">Wali Kelas</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>wali/wali/json", "type": "POST"},
        columns: [
        {
            "data": "nip",
            "orderable": false
    ...
    function view(nip)
    {
        ...
        $.ajax({
            url : '<?php echo site_url("wali/wali/view/'+nip+'") ?>',
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('.modal-title').text('Preview Data Wali Kelas'); // Set title to Bootstrap modal title
            },
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Wali" name="nama" required readonly/>
                                    <span class="help-block"></span>
                                </div>
                                <div class="form-group">
                                    <label>Kelas</label>
