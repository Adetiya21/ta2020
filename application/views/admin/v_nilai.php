			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>Berikut data nilai-nilai mapel : <?= $mp->nama_mapel; ?></span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/nilai/siswa/'.$kls->id.'/'.$mp->id) ?>">Nilai</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="page-body">
					<div class="card">
						...
						<div style="position: absolute;right: 20px; top: 15px;">
							<a href="<?= site_url('admin/nilai/cetak/'.$kls->id.'/'.$mp->id) ?>" class="btn btn-danger btn-round"><span class="fa fa-print"></span> Preview Cetak</a>	
						</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/nilai/json/<?= $kl1 ?>/<?= $mp1 ?>", "type": "POST"},
        columns: [
        {
            "data": "id_nilai",
            "orderable": false
    ...
    function edit(id)
    {
	    ...
	    $.ajax({
	        url : '<?php echo site_url("admin/nilai/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/nilai/tambah')?>";
    } else {
        url = "<?php echo site_url('admin/nilai/update')?>";
    }
