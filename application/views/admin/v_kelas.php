...
<script>
    ...
    function myFunction() {
        var x = document.getElementById("id_kelas");
			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/kelas') ?>">Kelas</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/kelas/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/kelas/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("admin/kelas/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Data Kelas'); // Set title to Bootstrap modal title
	        },
	        error: function (jqXHR, textStatus, errorThrown)
	        {
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/kelas/tambah')?>";
    } else {
        url = "<?php echo site_url('admin/kelas/update')?>";
    }
                        ...
                        <div class="row">
	                        <div class="col-md-12">
	                        	<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="ID Kelas" name="id" required maxlength="3" id="id" onkeypress='return check_int(event)'/>
