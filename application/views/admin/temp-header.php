						...
						<div class="nav-list">
							<div class="pcoded-inner-navbar main-menu">
								...
								<ul class="pcoded-item pcoded-left-item">								
									...
									<li class="kelas">
										<a href="<?= site_url('admin/kelas') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="mapel">
										<a href="<?= site_url('admin/mapel') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="guru">
										<a href="<?= site_url('admin/guru') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="nilai pcoded-hasmenu ">
										...
										<ul class="pcoded-submenu">
											...
											<li class="pcoded-hasmenu ">
												...
												<ul class="pcoded-submenu">
													<?php foreach ($mapel->result() as $key1) { ?>
														<li class="data-pdft">
															<a href="<?= site_url('admin/nilai/siswa/'.$key->id.'/'.$key1->id) ?>" class="waves-effect waves-dark">
																<span class="pcoded-mtext"><?= $key1->nama_mapel; ?></span>
															</a>
														</li>
													<?php } ?>
												</ul>
