			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/nilai') ?>">Nilai</a>
						</li>
                        <li class="breadcrumb-item">
                            <a href="<?= site_url('admin/nilai/cetak') ?>">Cetak Nilai</a>
                        </li>
					</ul>
				</div>
			</div>
    ...
    <div class="pcoded-inner-content"  style="margin-top: -20px;margin-bottom: -20px">
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    <a class="btn btn-danger btn-round" href="javascript:history.back()"><span class="fa fa-history"></span> Kembali</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="page-body">
                    <div class="card">
                        <div class="card-header">
                            <h5>Data Nilai Siswa <br><br><?= $kls->nama_kelas; ?> <br>Mata Pelajaran <?= $mp->nama_mapel; ?></h5>
