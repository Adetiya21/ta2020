            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">LOGIN GURU</h2>
                        <p class="text-center">Login untuk dapat memanagemen data website</p>
                        <?= $this->session->flashdata('pesan'); ?>
                        <?= $this->session->flashdata('error'); ?>
                        <?= form_open('guru/welcome/login'); ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="uname">NIP</label>
                                        <input class="form-control" id="uname" type="text" name="nip" 
                                            placeholder="Masukkan NIP" value="<?= $this->session->flashdata('nip'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
