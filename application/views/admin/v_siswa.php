...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/siswa/json/<?= $kls ?>", "type": "POST"},
        columns: [
        {
            "data": "nis",
            "orderable": false
    ...
    function hapus(nis)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/siswa/hapus/'+nis+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function tambah()
    {
        ...
        $('.modal-title').text('Tambah siswa Kelas'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(nis)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("admin/siswa/edit/'+nis+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Data siswa Kelas'); // Set title to Bootstrap modal title
	        },
	        error: function (jqXHR, textStatus, errorThrown)
	        {
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/siswa/tambah')?>";
    } else {
        url = "<?php echo site_url('admin/siswa/update')?>";
    }
