...
<div class="pcoded-content">
    ...
    <div class="pcoded-inner-content"  style="margin-top: -20px;margin-bottom: -20px">
        <div class="main-body">
            ...
            <div class="page-body">
                <a href="<?= site_url('nilai/nilai_akhir') ?>" class="btn btn-danger btn-round"><span class="fa fa-eye"></span> Preview Nilai Akhir</a>  
            </div>
        </div></div>
    </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>nilai/json", "type": "POST"},
        columns: [
        {
            "data": "id_nilai",
            "orderable": false
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('nilai/update')?>";
    }
